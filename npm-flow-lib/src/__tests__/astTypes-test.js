 ...
 */
describe('astTypes', () => {
  it('should parse TProgram data correctly', async () => {
    ...
    // NOTE: If we use import type {TProgram} from './src/astTypes', the check-contents cmd
    //       doesn't find the file for some reason... fell back to use abspath instead
    // (4) Codegen a file that types the parsed AST
    let fileToTypecheck =
      `/* @flow */ import type {TProgram} from '${TYPES_FILE_PATH}';\n`;
